...
return new class extends Migration {
    ...
    {
        Schema::create('0cc_basquet_pagos', function (Blueprint $table) {
            ...
            $table->integer('fecha')->comment('Unix Timestamp de la transaccion');
    ...
    {
        Schema::dropIfExists('0cc_basquet_pagos');
    }
};
