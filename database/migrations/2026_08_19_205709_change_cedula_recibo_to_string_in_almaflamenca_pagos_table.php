...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement('UPDATE `0cc_almaflamenca_pagos_unificada` SET `cedula_temp` = CAST(`cedula` AS CHAR), `recibo_temp` = CAST(`recibo` AS CHAR)');
    ...
    public function down(): void
    {
        ...
        DB::statement('UPDATE `0cc_almaflamenca_pagos_unificada` SET `cedula_temp` = CAST(`cedula` AS UNSIGNED), `recibo_temp` = CAST(`recibo` AS UNSIGNED)');
