...
class StoreAlmaflamencaClienteRequest extends FormRequest
{
    ...
    {
        return [
            'cedula' => ['required', 'string', 'max:20', 'regex:/^\d+$/', Rule::unique('0cc_almaflamenca_clientes', 'cedula')],
    ...
    public function messages(): array
    {
        return [
            ...
            'cedula.unique' => 'Esta cédula ya está registrada en Alma Flamenca.',
